...
exports.PARTS_WEAR_CONFIG_DEFAULTS = void 0;
exports.getTierFromCondition = getTierFromCondition;
exports.computeWearDelta = computeWearDelta;
exports.failureRoll = failureRoll;
exports.applyWearDelta = applyWearDelta;
const logger = __importStar(require("firebase-functions/logger"));
const admin_1 = require("../../shared/admin");
const notifications_1 = require("../../shared/notifications");
exports.PARTS_WEAR_CONFIG_DEFAULTS = {
    baseDeltas: {
 ...
 */
function getTierFromCondition(condition, thresholds = exports.PARTS_WEAR_CONFIG_DEFAULTS.tierThresholds) {
    if (condition >= thresholds.yellow)
        return "green";
    if (condition >= thresholds.orange)
        return "yellow";
    if (condition >= thresholds.red)
        return "orange";
    return "red";
}
/**
 ...
 */
function computeWearDelta(params) {
    if (params.trigger !== "race")
        return 0;
    ...
    if (params.raceStyle === "mostRisky")
        driverModifier = 1.3;
    else if (params.raceStyle === "risky")
        driverModifier = 1.15;
    else if (params.raceStyle === "defensive")
        driverModifier = 0.9;
 ...
 */
function failureRoll(tier, failureCurve) {
...
async function applyWearDelta(teamId, carIndex, seasonId, roundId, partsMap, params, hadIncident = false) {
    ...
    const logRef = admin_1.db.collection("wear_log").doc(logDocId);
    batch.set(logRef, {
        seasonId,
        roundId,
        teamId,
        ...
        trigger: "race",
        partDeltas,
        computedAt: admin_1.admin.firestore.FieldValue.serverTimestamp(),

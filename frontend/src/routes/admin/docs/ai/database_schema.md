...
seasonHistory?: SeasonHistoryEntry[]   // one entry per completed season
  SeasonHistoryEntry {
    ...
    poles:                   number    // team.seasonPoles at season end — written by runSeasonEndProcessing (issue #134)
    teamName:                string    // team display name at season end — written by runSeasonEndProcessing (issue #134)
  }
```
